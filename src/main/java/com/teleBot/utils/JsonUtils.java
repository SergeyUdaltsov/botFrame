...
public class JsonUtils {
    ...
    public static <T> T getObjectFromJsonStream(Class<T> type, InputStream json) {
        try {
            return jsonMapper.readValue(json, type);
        } catch (IOException e) {
            LOG.error("Error during deconvert object");
    ...
    public static <T> T getObjectFromJsonStream(TypeReference<T> type, InputStream json) {
        try {
            return jsonMapper.readValue(json, type);
        } catch (IOException e) {
            LOG.error("Error during deconvert object");
